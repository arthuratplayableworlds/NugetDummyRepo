...
static class GitVersionInformation
{
    ...
    public static string PreReleaseTag = "3";
    ...
    public static string FullBuildMetaData = "Branch.jenkins-ci.Sha.5cfa3b3dba53d59e0208a6941dad8b12fc4e7622";
    public static string MajorMinorPatch = "4.0.3";
    public static string SemVer = "4.0.3";
    public static string LegacySemVer = "4.0.3";
    public static string LegacySemVerPadded = "4.0.3";
    public static string AssemblySemVer = "4.0.3.0";
    public static string AssemblySemFileVer = "4.0.3.0";
    public static string FullSemVer = "4.0.3";
    public static string InformationalVersion = "4.0.3+Branch.jenkins-ci.Sha.5cfa3b3dba53d59e0208a6941dad8b12fc4e7622";
    public static string BranchName = "jenkins-ci";
    public static string EscapedBranchName = "jenkins-ci";
    public static string Sha = "5cfa3b3dba53d59e0208a6941dad8b12fc4e7622";
    public static string ShortSha = "5cfa3b3";
    public static string NuGetVersionV2 = "4.0.3";
    public static string NuGetVersion = "4.0.3";
    ...
    public static string UncommittedChanges = "83";
