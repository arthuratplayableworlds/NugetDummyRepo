...
static class GitVersionInformation
{
    ...
    public static string PreReleaseTag = "18";
    ...
    public static string FullBuildMetaData = "Branch.jenkins-ci.Sha.2a50d3b709ec96259c5ba63aad3b534378c8421d";
    public static string MajorMinorPatch = "3.0.1";
    public static string SemVer = "3.0.1";
    public static string LegacySemVer = "3.0.1";
    public static string LegacySemVerPadded = "3.0.1";
    public static string AssemblySemVer = "3.0.1.0";
    public static string AssemblySemFileVer = "3.0.1.0";
    public static string FullSemVer = "3.0.1";
    public static string InformationalVersion = "3.0.1+Branch.jenkins-ci.Sha.2a50d3b709ec96259c5ba63aad3b534378c8421d";
    public static string BranchName = "jenkins-ci";
    public static string EscapedBranchName = "jenkins-ci";
    public static string Sha = "2a50d3b709ec96259c5ba63aad3b534378c8421d";
    public static string ShortSha = "2a50d3b";
    public static string NuGetVersionV2 = "3.0.1";
    public static string NuGetVersion = "3.0.1";
    ...
    public static string CommitsSinceVersionSource = "18";
    public static string CommitsSinceVersionSourcePadded = "0018";
