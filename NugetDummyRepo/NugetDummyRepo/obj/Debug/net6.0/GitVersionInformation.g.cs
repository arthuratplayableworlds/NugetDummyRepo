...
static class GitVersionInformation
{
    ...
    public static string PreReleaseTag = "11";
    ...
    public static string FullBuildMetaData = "Branch.main.Sha.4e2b14674d4798eae48d519746a7642e7e634787";
    public static string MajorMinorPatch = "2.1.2";
    public static string SemVer = "2.1.2";
    public static string LegacySemVer = "2.1.2";
    public static string LegacySemVerPadded = "2.1.2";
    public static string AssemblySemVer = "2.1.2.0";
    public static string AssemblySemFileVer = "2.1.2.0";
    public static string FullSemVer = "2.1.2";
    public static string InformationalVersion = "2.1.2+Branch.main.Sha.4e2b14674d4798eae48d519746a7642e7e634787";
    public static string BranchName = "main";
    public static string EscapedBranchName = "main";
    public static string Sha = "4e2b14674d4798eae48d519746a7642e7e634787";
    public static string ShortSha = "4e2b146";
    public static string NuGetVersionV2 = "2.1.2";
    public static string NuGetVersion = "2.1.2";
    ...
    public static string UncommittedChanges = "45";
