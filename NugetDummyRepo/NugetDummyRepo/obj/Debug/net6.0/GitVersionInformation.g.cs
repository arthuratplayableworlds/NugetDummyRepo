...
static class GitVersionInformation
{
    ...
    public static string FullBuildMetaData = "Branch.jenkins-ci.Sha.f9bbf0c24004cd6b00828f8aca0c77c3e0766d4f";
    public static string MajorMinorPatch = "4.0.1";
    public static string SemVer = "4.0.1";
    public static string LegacySemVer = "4.0.1";
    public static string LegacySemVerPadded = "4.0.1";
    public static string AssemblySemVer = "4.0.1.0";
    public static string AssemblySemFileVer = "4.0.1.0";
    public static string FullSemVer = "4.0.1";
    public static string InformationalVersion = "4.0.1+Branch.jenkins-ci.Sha.f9bbf0c24004cd6b00828f8aca0c77c3e0766d4f";
    public static string BranchName = "jenkins-ci";
    public static string EscapedBranchName = "jenkins-ci";
    public static string Sha = "f9bbf0c24004cd6b00828f8aca0c77c3e0766d4f";
    public static string ShortSha = "f9bbf0c";
    public static string NuGetVersionV2 = "4.0.1";
    public static string NuGetVersion = "4.0.1";
